...
from exception import ManualError, Error
...
class MainWindow:
    def __init__(self):
        ...
        eat_active_screen = argument == "--active"
        eat_cropped_screen = argument == "--cropped"
        ...
        # Get filename for different configurations
        self.glade_filename = os.path.join(source_dir, "screeneat.glade")

        self.temp_dir = "/tmp"

        # Load all configuration files
        self.privateauth = Config(privateauth_filename)
        self.publicauth = Config(
            publicauth_filename,
